...
class Nivel():
 	...
 	def __init__(self, archivo):
		...
		self.origen= self.interprete.get('nivel2','origen')
		self.c_ancho=int(self.interprete.get('nivel2','cal'))
		self.c_alto=int(self.interprete.get('nivel2','can'))
		self.mapa=self.interprete.get('nivel2','mapa').split('\n')
